...
| [n8n](n8n) | `ghcr.io/kizoukun/yolks:n8n` |
...
| `ghcr.io/kizoukun/yolks:n8n` | [`yolks/n8n`](yolks/n8n) | `n8n` (latest stable release), `n8n_<version>` |

The Hermes Agent and n8n workflows check for a new upstream release every 6 hours and can be run manually with a specific version. The Nginx PHP images are rebuilt weekly for Alpine security updates.
